...
public class aIHMModifierEleveAncien extends javax.swing.JPanel {
 frames.FFondFenetreProfesseur f;
    /** Creates new form IHMAjouterEleve */
    public aIHMModifierEleveAncien( frames.FFondFenetreProfesseur f, Eleve eleveAmodifier) {
        this.f=f;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        aIHMRechercherEleveAncien p = new aIHMRechercherEleveAncien(f,2);
        f.setPanel(p);
