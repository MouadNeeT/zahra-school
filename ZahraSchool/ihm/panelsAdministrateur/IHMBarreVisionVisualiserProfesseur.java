 ...
 * @author Evi and Max
 */
public class IHMBarreVisionVisualiserProfesseur extends javax.swing.JPanel {

	FFondFenetreAdministrateur f;
    /** Creates new form IHMBarreVisionVisualiserProfesseur */
    public IHMBarreVisionVisualiserProfesseur(FFondFenetreAdministrateur f) {
    	this.f = f;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visualiser la fiche d'un professeur");
