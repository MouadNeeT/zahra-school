 ...
 * @author Evi and Max
 */
public class IHMBarreVisionModifierProfesseur extends javax.swing.JPanel {

	FFondFenetreAdministrateur f;
    /** Creates new form IHMBarreVisionVisualiserProfesseur */
    public IHMBarreVisionModifierProfesseur(FFondFenetreAdministrateur f) {
    	this.f = f;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modifier un professeur");
