...
public class IHMBarreHautAdministrateur extends JPanel{
	frames.FFondFenetreAdministrateur f2;
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;

    public IHMBarreHautAdministrateur(frames.FFondFenetreAdministrateur f2) {
        this.f2 = f2;
    	initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ZahraSchool");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel2.setText("Ecole de soutien scolaire");
