 ...
 * @author Evi and Max
 */
public class IHMModificationProfesseur extends javax.swing.JPanel {
    frames.FFondFenetreProfesseur f;

    /** Creates new form IHMModifierSupprimerProfesseur */
    public IHMModificationProfesseur(frames.FFondFenetreProfesseur f) {
    	this.f = f;
        initComponents();
        boutonSupprimer.setVisible(false);
        listeProfesseurs = ProfesseurManager.getInstance().getAllProfesseurs();
    ...
    ArrayList<Professeur> listeProfesseurs = null;
